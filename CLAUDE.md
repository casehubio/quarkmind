...
- Tests: (continued) `PatternClassificationRuleUnitTest`, `PatternClassificationCalibrationTest`, `DominanceWeightRuleUnitTest`, `SC2CbrRetentionIT`, `SC2CbrRoutingIT`, `WorkbenchSocketIT`
