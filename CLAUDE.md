...
- Tests: (continued) `PatternClassificationRuleUnitTest`, `PatternClassificationCalibrationTest`, `DominanceWeightRuleUnitTest`, `SC2CbrRetentionIT`, `SC2CbrRoutingIT`, `WorkbenchSocketIT`, `LlmPatternFallbackIT`
...
src/main/java/io/quarkmind/
  ...
  plugin/coaching/     Coach mode — CoachingTriggerBuilder, CoachingWorkerFactory, CoachingChannelBroker, CoachingComplianceEvaluator, VerificationPredicate (sealed hierarchy), LocationReference + LocationResolver
  ...
  qa/workbench/        Workbench WebSocket — WorkbenchEnricher, WorkbenchBroadcaster, WorkbenchSocket, typed payload records
```
