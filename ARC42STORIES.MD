...
**Known limitation:** `GameOutcomeRecorder` records `SOUND` for all games until real win/loss detection ships (#189). With uniform SOUND verdicts, trust routing produces no strategic learning.
