 ...
 */
public class Event extends StructView {

	/** Field name constants (copied from IEvent). */
	...
	private static final Set< String > GENERAL_FIELD_NAMES = new HashSet<>( Arrays.asList( F_NAME, F_ID, F_LOOP, F_PLAYER_ID, F_USER_ID ) );
