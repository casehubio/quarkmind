...
public class Protocol {
	...
	public static final Set< Integer >			  BETA_BASE_BUILD_SET = new HashSet<>( Arrays.asList( 17266, 18468, 19458, 19595, 21955, 24764, 27950, 28272, 34784, 34835,
	...
	public static Protocol get( Integer baseBuild ) {
		if ( baseBuild > LATEST_BASE_BUILD  && true ) {
		...
		if ( p == null && !BBUILD_PROTOCOL_MAP.containsKey( baseBuild ) ) {
			try {
				...
				if ( !( e instanceof MissingResourceException ) )
					LOGGER.errorf( e, "Failed to load static protocol data for base build: %d", baseBuild );
			}
