...
public enum PlayerColor implements IPlayerColor {
	...
	/**
	 * Creates a new {@link PlayerColor}.
	 *
	...
	private PlayerColor( final String text, final Color color ) {
		...
		cssColor = "rgb(" + color.getRed() + "," + color.getGreen() + "," + color.getBlue() + ")";
		darkerCssColor = "rgb(" + darkerColor.getRed() + "," + darkerColor.getGreen() + "," + darkerColor.getBlue() + ")";
	}
