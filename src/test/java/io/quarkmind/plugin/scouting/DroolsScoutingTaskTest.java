...
class DroolsScoutingTaskTest {
    ...
    void assessmentsChanged_differentSize_returnsTrue() {
        var prev = List.of(new EnemyPatternAssessment(StrategyArchetype.TERRAN_MARINE_RUSH, 0.6, 100, "test"));
    ...
    void assessmentsChanged_differentArchetype_returnsTrue() {
        var prev = List.of(new EnemyPatternAssessment(StrategyArchetype.TERRAN_MARINE_RUSH, 0.6, 100, "test"));
        var curr = List.of(new EnemyPatternAssessment(StrategyArchetype.ZERG_ZERGLING_RUSH, 0.6, 200, "test"));
        assertThat(DroolsScoutingTask.assessmentsChanged(prev, curr)).isTrue();
    }

    @Test
    void assessmentsChanged_crossesThreshold_returnsTrue() {
        var prev = List.of(new EnemyPatternAssessment(StrategyArchetype.TERRAN_MARINE_RUSH, 0.49, 100, "test"));
        var curr = List.of(new EnemyPatternAssessment(StrategyArchetype.TERRAN_MARINE_RUSH, 0.51, 200, "test"));
        assertThat(DroolsScoutingTask.assessmentsChanged(prev, curr)).isTrue();
    }

    @Test
    void assessmentsChanged_sameArchetypeSameBand_returnsFalse() {
        var prev = List.of(new EnemyPatternAssessment(StrategyArchetype.TERRAN_MARINE_RUSH, 0.55, 100, "test"));
        var curr = List.of(new EnemyPatternAssessment(StrategyArchetype.TERRAN_MARINE_RUSH, 0.59, 200, "test"));
