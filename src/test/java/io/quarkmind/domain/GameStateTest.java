...
class GameStateTest {
    ...
    void initialProtossGameState() {
        ...
        var state = new GameState(50, 0, 15, 1, List.of(probe), List.of(nexus), List.of(), List.of(), List.of(), List.of(), List.of(), 0L, null);
    ...
    void probeCount() {
        ...
        var state = new GameState(50, 0, 15, 3, probes, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), 0L, null);
