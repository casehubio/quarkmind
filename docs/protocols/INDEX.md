...
| [nearest-threat-conditional-write.md](nearest-threat-conditional-write.md) | NEAREST_THREAT written only when !enemies.isEmpty(), and value must be non-null — gate depends on key absence; null value causes NPE in get() (#175) | All ScoutingTask implementations |
