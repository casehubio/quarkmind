...
public enum Region implements IRegion {
	...
	/** US */
	US( "US", "US", 1, "https://us-s2-depot.classic.blizzard.com/", "http://us.battle.net/", BnetLang.ENGLISH, EnumSet.of( BnetLang.ENGLISH,
	        BnetLang.SPANISH, BnetLang.PORTUGUESE ), Realm.NORTH_AMERICA, Realm.LATIN_AMERICA ),

	/** Europe */
	EUROPE( "Europe", "EU", 2, "https://eu-s2-depot.classic.blizzard.com/", "http://eu.battle.net/", BnetLang.ENGLISH, EnumSet.of( BnetLang.ENGLISH,
	...
	/** Korea */
	KOREA( "Korea", "KR", 3, "https://kr-s2-depot.classic.blizzard.com/", "http://kr.battle.net/", BnetLang.KOREAN, EnumSet.of( BnetLang.KOREAN,
	        BnetLang.CHINESE_TRADITIONAL ), Realm.KOREA, Realm.TAIWAN ),

	/** China */
	CHINA( "China", "CN", 5, "http://cn.depot.battle.net:1119/", "http://www.battlenet.com.cn/", BnetLang.CHINESE_TRADITIONAL, EnumSet
	        .of( BnetLang.CHINESE_TRADITIONAL ), Realm.CHINA ),

	/** South East Asia */
	SEA( "SEA", "SG", 6, "http://sg.depot.battle.net:1119/", "http://sea.battle.net/", BnetLang.ENGLISH, EnumSet.of( BnetLang.ENGLISH ), Realm.SEA ),

	/** Public Test */
	PUBLIC_TEST( "Public Test", "XX", 98, "http://xx.depot.battle.net:1119/", "http://us.battle.net/", BnetLang.ENGLISH, EnumSet.of( BnetLang.ENGLISH ) ),

	/** Unknown */
	UNKNOWN( "Unknown", "", -1, "http://unknown.depot.battle.net:1119/", "http://unknown.battle.net/", BnetLang.ENGLISH, EnumSet.of( BnetLang.ENGLISH ) );
